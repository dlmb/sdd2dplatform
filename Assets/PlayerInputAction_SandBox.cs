// GENERATED AUTOMATICALLY FROM 'Assets/PlayerInputAction_SandBox.inputactions'
...
public class PlayerInputAction_SandBox : IInputActionCollection
{
    private InputActionAsset asset;
    public PlayerInputAction_SandBox()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""PlayerInputAction_SandBox"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private PlayerInputAction_SandBox m_Wrapper;
        public PlayerActions(PlayerInputAction_SandBox wrapper) { m_Wrapper = wrapper; }
